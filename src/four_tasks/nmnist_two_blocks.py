...
# Get parameters
experiment_number = 0
parameters_path = "../../params/four-tasks-two-blocks.xml"
...
result_path = f'results/Four-tasks-NMNIST-two-blocks-{experiment_number:02d}'
...
for epoch in range(epochs):
    ...
    test4_acc = stats.testing[3].accuracy[0]
    print(f'| Test3 loss = {test4_loss:0.4f} acc = {test4_acc:0.4f}', end=' ')
